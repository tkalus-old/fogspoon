...
class Service(object):
    ...
    def first_or_create(self, **kwargs):
        """Returns the first instance found of the service's model filtered by
        the specified key word arguments OR a new, saved instance of the
        service's model class.

        :param **kwargs: filter parameters
        """
        instance = self.first(**kwargs)
        return instance if instance else self.create(**kwargs)
